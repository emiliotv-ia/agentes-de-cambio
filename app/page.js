...
export default function LandingPage() {
  ...
  const acciones = [
    ...
    { icon: "🤝", titulo: "Postulate como Agente de Cambio", desc: "Doná tu tiempo, habilidades o recursos. TODO SUMA", accion: "voluntario", img: "https://raw.githubusercontent.com/emiliotv-ia/agentes-de-cambio/main/public/voluntarios.png" },
          ...
          {acciones.map((item, i) => {
            ...
            return (
              <a
                ...
                style={{ borderRadius: 16, overflow: "hidden", textDecoration: "none", display: "block", position: "relative", height: isVoluntario ? 220 : 160, boxShadow: "0 4px 16px rgba(0,0,0,0.12)", cursor: "pointer" }}
              >
